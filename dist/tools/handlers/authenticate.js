...
import { generateAuthorizationUrl, exchangeCodeForTokens, getOAuthInstructions, } from "../../credentials/oauth-client.js";
/**
 * Handle the qbo_authenticate tool
 * This tool does NOT require a QuickBooks client - it's used to set up credentials
 */
export async function handleAuthenticate(args) {
    ...
    if (args.authorization_code) {
        ...
        try {
            const result = await exchangeCodeForTokens(clientId, clientSecret, args.authorization_code, args.realm_id);
